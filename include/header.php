...
<ul id="nav">
	...
	<li><a href="service.php">Service</a>
        <ul>    <li><a href="RecordsMgt.php">Records Management</a></li>
		<li><a href="Edm.php">Electronic Document Management</a></li>
		<li><a href="ComplianceMgt.php">Compliance Management</a></li>
                <li><a href="DAM.php">Document Archiving + Management</a></li>
                <li><a href="CSoln_DataBackup.php">Cloud Solution + Data Backup</a></li>	
		</ul></li>
	<li><a href="solution.php">Solutions</a>
		<ul >
		<table>
  <tr>
